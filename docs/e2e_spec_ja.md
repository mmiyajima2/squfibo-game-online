...
- [x] タイトル「SquFibo」が表示される
- [x] ゲーム説明文が表示される
- [x] 「オンライン版を開始する」ボタンが動作する
- [x] 「ブラウザ版」外部リンクが正しいURLを持つ
- [x] 「マニュアル」リンクが `/manual` に遷移する
- [x] 現在の部屋数が表示される（`X / 89`形式）

### 5.2 部屋作成ダイアログ

- [x] プレイヤー名入力フィールドが表示される
- [x] プレイヤー名が空の場合、作成ボタンが無効または送信不可
- [x] プレイヤー名が21文字以上の場合、入力制限またはエラーが出る
- [x] 作成成功後、ゲーム画面に遷移する
...
- [x] ホスト名が表示される
- [x] ゲスト参加待ちの場合、招待URLが表示される（ホスト側のみ）
- [x] ゲストが参加したら招待URLが非表示になる
- [x] スタート/準備ボタンが表示される

### 5.5 ゲーム画面（進行中）

- [x] 3×3の盤面グリッドが表示される
- [x] 各プレイヤーの手札が表示される（自分の手札のみ操作可能）
- [x] 各プレイヤーの星数が表示される
- [x] 現在のターンが明示される
- [x] 山札の残り枚数が表示される
- [x] アクティブプレイヤーのみカード操作ができる
- [x] 役申告ボタンが適切なタイミングで表示される
- [x] ターン終了ボタンが表示される
- [x] 退出ボタンがヘッダーに表示される
- [x] ゲームログ（コメンタリー）が更新される

### 5.6 ゲーム終了画面

- [x] 勝者または引き分けが表示される
- [x] 各プレイヤーの最終星数が表示される
- [x] 終了理由（星獲得完了 / 山札切れ）が表示される
- [x] ウェルカム画面に戻るボタンが表示される
...
| 1.0.1 | 2026-02-20 | TC-09, TC-14 を OK に更新（バグ修正対応済み） |
